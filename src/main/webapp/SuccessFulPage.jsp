      ...
      <div class="navbar-nav ms-auto">
        <%
          try{
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/nikesh", "root", "123456");
        ...
        <h2>Hi <span style="color: red; font-size: 20px;">${message1}</span><br> </h2>
        <form action="index.jsp" method="post" ><button type="submit" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">LogOut</button>&nbsp;&nbsp;&nbsp;&nbsp;</form>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <l>https://fontawesome.com/icons/twitter?f=brands&s=solid</l>
      </div>
    </div>
  </div>
</div>
